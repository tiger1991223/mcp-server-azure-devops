...
// Mock the createWorkItem feature
jest.mock('./feature', () => {
...
const { createWorkItem } = require('./feature');
...
describe('createWorkItem', () => {
  ...
  it('should create a work item with required fields', async () => {
    ...
    createWorkItem.mockImplementationOnce(
      async (_: any, projectId: string, workItemType: string, fields: any) => {
        // Call the mocked API
        ...
        return await mockWorkItemTrackingApi.createWorkItem(
          document,
          {},
          projectId,
          workItemType,
    ...
    // Call createWorkItem
    const result = await createWorkItem(mockConnection, 'testproject', 'Task', {
    ...
    const document: JsonPatchDocument =
      mockWorkItemTrackingApi.createWorkItem.mock.calls[0][0];
  ...
  it('should throw AzureDevOpsAuthenticationError when API call fails', async () => {
    ...
    mockWorkItemTrackingApi.createWorkItem.mockRejectedValueOnce(
